        ...
        marker.addListener('click', function() {
          ...
          function callback(place, status) {
            ...
            if (status == google.maps.places.PlacesServiceStatus.OK) {
              ...
              if (address) content += `<p><b>Address:</b> ${address}</p>`
              if (phone) content += `<p><b>Phone:</b> ${phone}</p>`
              if (website) content += `<p><b>Website:</b> <a target="_blank" href="${website}">Click here</a></p>`
              // Closing the content
              content += `</div>`;
